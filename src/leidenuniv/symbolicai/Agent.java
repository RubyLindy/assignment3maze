...
public abstract class Agent {
	...
	boolean HUMAN_DECISION = true;// change to false if you want the decide step to make the decision rather than
	...
	public void sense(Maze w) {
		...
		// System.out.println("PERCEPT INFERENCE:\n"+result);//uncomment this if you
		// want to know what facts your forward chaining inference produces
	...
	public void think(KB b, KB d, KB i) {
		...
		// System.out.println("THINK INFERENCE:\n"+facts);//uncomment this if you want
		// to know what facts your forward chaining inference produces
	...
	public Predicate decide(boolean humanActor) {
		...
		if (humanActor) {
			...
			for (Sentence d : desires.rules()) {
				Plan plan = idSearch(7, believes, new Predicate(d));// calls your iterative deepening search to find a
																	// okan for Predicate d, keep at 7 maxDepth, you
																	// don't need more
	...
	// public abstract boolean findAllSubstitutions(ArrayList<HashMap<String,
	// String>> allSubstitutions, HashMap<String, String> substitution,
	...
	// Substitutes all variable terms in a copy of predicate <old> for values in
	// substitution <s> and returns the copy
